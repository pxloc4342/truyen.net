...
<body>
  <a href="/WebTruyenTranh/" class="btn btn-outline-primary" style="font-weight:500; font-size:12px; padding:2px 12px; border-radius:12px; height:32px; line-height:28px; position:absolute; top:8px; left:8px; z-index:1000;">TRANG CHỦ</a>
  <div class="section">
    <div class="container">
